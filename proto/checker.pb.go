...
type CheckResponse struct {
	...
	CheckerNodeTag string                 `protobuf:"bytes,12,opt,name=checker_node_tag,json=checkerNodeTag,proto3" json:"checker_node_tag,omitempty"` // Node tag for identifying which checker processed this
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CheckResponse) GetCheckerNodeTag() string {
	if x != nil {
		return x.CheckerNodeTag
	}
	return ""
}
...
type HealthResponse struct {
	...
	CheckerNodeTag string                 `protobuf:"bytes,6,opt,name=checker_node_tag,json=checkerNodeTag,proto3" json:"checker_node_tag,omitempty"` // Node tag for identifying the checker
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *HealthResponse) GetCheckerNodeTag() string {
	if x != nil {
		return x.CheckerNodeTag
	}
	return ""
...
func (x *StatsResponse) GetCheckerNodeTag() string {
	if x != nil {
		return x.CheckerNodeTag
	}
	return ""
...
const file_checker_proto_rawDesc = "" +
	...
	"\x10checker_node_tag\x18\f \x01(\tR\x0echeckerNodeTag\"\x0f\n" +
	...
	"\adetails\x18\x05 \x03(\v2'.checker.v1.HealthResponse.DetailsEntryR\adetails\x12(\n" +
	"\x10checker_node_tag\x18\x06 \x01(\tR\x0echeckerNodeTag\x1a:\n" +
	...
	"\x10checker_node_tag\x18\x06 \x01(\tR\x0echeckerNodeTag*[\n" +
	"\vCheckStatus\x12\v\n" +
